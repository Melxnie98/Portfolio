  ...
  return (
    <Layout>
      <Head>
        ...
        <SEO title={globalData.name + " - accessBugsTwo"} description={globalData.blogTitle} />
        <title>Melanie Leonard - accessBugsTwo</title>
      </Head>
      
      <Header>
        <title>ACCESSABILITY BUG TEST PAGE</title>
      </Header>
